...
/**
 * @file   Test Suite to verify results match OscState${f}.json which is a subset of the entire catalog from Aug 2022
...
`;
  ...
  fs.writeFileSync(`test/sgp4/full-catalog/sgp4-catalog-${f}.test.js`, fileContent, 'utf8');
}
